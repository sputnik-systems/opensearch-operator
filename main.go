...
import (
	...
	"github.com/preved911/opensearch-operator/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "72259b2b.sputnik.systems",
	})
	if err != nil {
	...
	if err = (&controllers.IndexStateManagementPolicyReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "IndexStateManagementPolicy")
		os.Exit(1)
	}
